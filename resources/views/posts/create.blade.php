        ...
        <x-panel>
            <form action="/admin/posts" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input
                        type="text" name="title" id="title" class="border border-gray-400 p-2 w-full"
                ...
                <div class="mb-6">
                    ...
                    <input
                        type="text" name="slug" id="slug" class="border border-gray-400 p-2 w-full"
                ...
                <div class="mb-6">
                    ...
                    <input
                        type="file" name="thumbnail" id="thumbnail" class="border border-gray-400 p-2 w-full"
                        required>
